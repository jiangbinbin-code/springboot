...
public class CrcUtil {
    ...
    private static  String qrCode="0002010102110408000317135204439953038405802ZW5914ZENGEZA 1 HIGH6006HARARE62210305000000708000000006304";
    ...
    public static void main(String args[]){
        byte[] data=strToByteArray(qrCode);
        byte[] crcData = CrcUtil.setParamCRC(data);
        String  ccitt=byteArrayToStr(crcData);
