	...
	methods: {
		...
		saveOrUpdate: function (event) {
		    $('#btnSaveOrUpdate').button('loading').delay(1000).queue(function() {
                var url = vm.daily.id == null ? "sys/daily/save" : "sys/daily/update";
                $.ajax({
                    type: "POST",
                    url: baseURL + url,
		...
		getInfo: function(id){
			$.get(baseURL + "sys/daily/info/"+id, function(r){
                vm.daily = r.daily;
            });
		},
